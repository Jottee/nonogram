...
public class SPI2 implements Runnable {
    ...
    private byte[] check = new byte[]{DUMMY_BYTE};
    private List<Byte> in = new ArrayList<>();
    private MainFrame2 fr;
    private Object userInputMonitor = new Object();

    public SPI2(MainFrame2 fr) {
        this.fr = fr;
    }
        ...
        while (console.isRunning()) {
            synchronized (userInputMonitor) {
                try {
                    ...
                    console.println("InterruptedException while waiting \n" + e);
                }
            }
